...
The `TypedDict` class is used to define a dictionary with a specific structure, and the `Annotated` class is used to add additional information to the type hint for the `messages` field.
